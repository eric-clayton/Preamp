...
Parameter_t frequencyKnobHigh = { 127, 254,  1,  4,   150,    10, false, false, DisplayFreqHigh,         UpdateHFFrequencyWipers};
Parameter_t QKnobLow          = { 127, 254,  1,  4,     9,     1, false, false, DisplayQ,                UpdateLFQWipers};
Parameter_t QKnobHigh         = { 127, 254,  1,  4,     9,     1, false, false, DisplayQ,                UpdateHFQWipers};
// Sub
...
Parameter_t subOuputKnob      = {   0, 254,  4,  4,    20,     5, false, false, DisplayOutputGain,       UpdateOutputWipers};
// Inputs
...
Parameter_t inputOneGainKnob   = {   127, 254,  1,  1,    20,     5, false,  false, DisplayInputGain,    UpdateInputOneGainWipers};
...
Parameter_t inputTwoGainKnob   = {   127, 254,  1,  1,    20,     5, false,  false, DisplayInputGain,    UpdateInputTwoGainWipers};
...
Parameter_t inputThreeGainKnob   = {   127, 254,  1,  1,    20,     5, false,  false, DisplayInputGain,    UpdateInputThreeGainWipers};
...
Parameter_t inputBtGainKnob   = {   127, 254,  1,  1,    20,     5, false,  false, DisplayInputGain,    UpdateInputBtGainWipers};
...
Parameter_t* allParameters[] = {
    ...
    &subLevelLeftKnob, &subLevelRightKnob, &subOuputKnob, &inputOneOnKnob, &inputOneOffKnob, &inputOneGainKnob,
    &inputTwoOnKnob, &inputTwoOffKnob, &inputTwoGainKnob, &inputThreeOnKnob, &inputThreeOffKnob, &inputThreeGainKnob,
    &inputBtOnKnob, &inputBtOffKnob, &inputBtGainKnob
};
